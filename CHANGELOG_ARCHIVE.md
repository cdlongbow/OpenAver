# Changelog Archive (v0.1.0 ~ v0.12.10)
...
- [0.12.10] 2026-07-24 — showcase 呈現優化（手機封面吃滿寬度 + 觸控封面 icon 移入燈箱 + 女優牆卡片兩段式欄數對齊影片牆）
- [0.12.9] 2026-07-24 — 桌面版啟動自動檢查更新 + 深色主題按鈕修復 + 整理候選污染隱性 bug 修復 + WSL2 拖檔錯誤訊息修正
- [0.12.8] 2026-07-22 — 搜尋頁詳情卡整理前手動修正（演員可編 + 發售日日曆補選）+ 修復整理送出非當前候選版本
- [0.12.7] 2026-07-22 — 唯讀/一般來源刮削記帳邏輯收斂單一實作（enrich_contract）+ 唯讀破圖/原文標題清空等 bugfix
- [0.12.6] 2026-07-21 — 唯讀來源就地取用本地 NFO/封面（不再重刮）+ 唯讀片解禁補料/重刮/補劇照
- [0.12.5] 2026-07-20 — 技術債清償（中文硬編碼 i18n 收斂 ~130 行 + 拖曳/貼上番號辨識規則統一 + 辨識失敗明說 + logger/中文硬編碼 lint 守衛上線）
- [0.12.4] 2026-07-18 — 別名女優換照片修復（本機候選選了就能換 + 重抓自動輪替別名查雲端圖庫）+ 滾輪橫向/垂直切換上一片下一片
- [0.12.3] 2026-07-18 — 對焦裁切收尾（媒體伺服器海報自動對臉裁切 + 燈箱對焦視覺連續交棒 + 影片對焦鈕僅窄螢幕/手機顯示）
- [0.12.2] 2026-07-16 — 女優照片可自行上傳 + 女優頭像手動對焦裁切首發
- [0.12.1] 2026-07-15 — 焦點裁切收尾（燈箱點焦點→自動對焦→拖曳微調正式互動 + 唯讀來源自動對焦 + 小格裁切精準對齊燈箱大圖）
- [0.12.0] 2026-07-14 — 焦點裁切首發：無碼封面（FC2/素人/uncensored）自動偵測人臉、以臉為中心裁切封面
