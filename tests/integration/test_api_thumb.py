...
class TestUriToLocalFsPathReverseMappingThumb:
    ...
    re-read 的 fresh_fs）在 WSL + UNC path_mappings 環境下，餵給磁碟 I/O
    （thumbnail_cache.generate/os.path.exists）的路徑必須是反解後的本機路徑，
    而不是裸 uri_to_fs_path() 產生的映射端 UNC 字串。
    """
