...
def _fake_search_jav(number, source="auto", proxy_url="", javbus_lang=None, **_kw):  # **_kw：TASK-118-T6 P2-1b 起 produce_source 會多傳 blocked_out；本 stub 不關心它
...
def _fake_search_jav_round1(number, source="auto", proxy_url="", javbus_lang=None, **_kw):  # **_kw：TASK-118-T6 P2-1b 起 produce_source 會多傳 blocked_out；本 stub 不關心它
...
def _fake_search_jav_round2(number, source="auto", proxy_url="", javbus_lang=None, **_kw):  # **_kw：TASK-118-T6 P2-1b 起 produce_source 會多傳 blocked_out；本 stub 不關心它
