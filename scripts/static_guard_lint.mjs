...
const RULES = [
  ...
  { file: 'web/templates/search.html', kind: 'required-string', pattern: "'has-cover': !actressLightboxMode() && !!(currentLightboxVideo()?.preview_cover_url || currentLightboxVideo()?.cover) && !_heroLightboxImageError", note: '[TestUS9SearchGridMobileFix] test_search_lightbox_has_cover_class（TASK-113c-T3b：preview_cover_url 優先 fallback cover）' },
